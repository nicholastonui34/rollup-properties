...
export const NEWS_ARTICLES: NewsArticle[] = [
  {
    slug: "nyoomba-launches-in-nairobi",
    title: "Nyoomba is live in Nairobi",
    excerpt:
    ...
    body: [
      ...
      "Nyoomba is our answer to that: a marketplace where every listing is checked by a real person before it goes live, and where you deal directly with the property manager once you unlock their contact. No broker fee, no middleman, no guessing.",
      "## What's live today",
  ...
  },
  {
    ...
    excerpt:
      "The verified badge isn't automatic — here's what a Nyoomba verifier actually checks before a listing goes live, and why we re-confirm it over time.",
    publishedAt: "2026-07-19",
    body: [
      "A verified badge only means something if it's backed by an actual check. Here's what happens between a lister submitting a listing and it going live on Nyoomba.",
      "## The check",
      "A Nyoomba verifier confirms the listing's photos genuinely match the unit, the address is real and matches where the property actually sits, and the lister has the right to manage or let the property — whether that's ownership, a management agreement, or agency authorization.",
  ...
  },
  {
    ...
    excerpt:
      "Nyoomba replaces broker viewing fees with a single, transparent, one-time payment — here's exactly what it buys you.",
    publishedAt: "2026-07-19",
    body: [
      ...
      "Nyoomba replaces that with one transparent, one-time payment: KES 99 to unlock a property manager's direct phone number on any listing. No subscription, no repeat fees for the same listing, no broker taking a cut of your future rent.",
      "## What you get",
