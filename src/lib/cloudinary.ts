...
export const CLOUDINARY_FOLDER = "nyoomba/listings";
export const CLOUDINARY_EVIDENCE_FOLDER = "nyoomba/verification-evidence";
export const CLOUDINARY_APPLICATION_DOCS_FOLDER = "nyoomba/applications";
